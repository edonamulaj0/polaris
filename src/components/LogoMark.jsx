...
function CompassRoseStar({ className = '' }) {
  return (
    <svg
      className={className}
      width="32"
      ...
      aria-hidden
    >
      <circle cx="16" cy="16" r="15" fill="url(#compass-bg)" opacity="0.15" />
      <path
      ...
      <defs>
        <linearGradient id="compass-bg" x1="0" y1="0" x2="32" y2="32">
          <stop stopColor="#F4D068" />
          <stop offset="1" stopColor="#E2E8F0" />
        </linearGradient>
        <linearGradient id="star-gold" x1="16" y1="2" x2="16" y2="30">
          <stop stopColor="#F4D068" />
          <stop offset="1" stopColor="#E2E8F0" />
        </linearGradient>
        <linearGradient id="star-inner" x1="16" y1="6" x2="16" y2="26">
  ...
  return (
    <Link to="/" className={`group inline-flex select-none ${compact ? 'items-center gap-2.5' : 'flex-col items-start gap-0.5'} ${className}`}>
      <span className="inline-flex items-center gap-2.5">
        <CompassRoseStar className="h-8 w-8 shrink-0 transition-transform duration-300 group-hover:scale-105" />
        <span
